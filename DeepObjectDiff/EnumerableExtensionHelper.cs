...
namespace DeepObjectDiff
{
    ...
    {
        /// <summary>
        ///     Works like <see cref="System.Linq.Enumerable.Zip{TFirst,TSecond,TResult}" />, however it will continue using
        ///     <code>default()</code> if one of the enumerations ends before another.
        /// </summary>
        ...
        ///     Func that merges elements of <typeparamref name="TFirst" /> and
        ///     <typeparamref name="TSecond" /> to create <typeparamref name="TResult" />
        /// </param>
        /// <returns></returns>
        internal static IEnumerable<TResult> ZipFullLength<TFirst, TSecond, TResult>(
